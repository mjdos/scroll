@include('site.layout.header')
    ...
    <div class="main-content-area product-ds">
        ...
        <div class="product-image">
            <img src="{{ url('assets/img/content/product-img/product-2.png')}}" alt="Product Image">
        </div>
        <div class="product-info">
            <div class="tabs-block swiper-container">
                ...
                <ul class="tabs-list swiper-wrapper">
                    ...
                    <li class="swiper-slide"><a href="#tab2">Comments <span class="count">2</span></a></li>
                    <li class="swiper-slide"><a href="#tab3">Reviews <span class="count">1</span></a></li>
                </ul>
