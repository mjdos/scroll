...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- -------------------------------------------------------------- -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style='background-image: url("assets/img/fundo.webp");background-repeat: repeat-x;'>
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span><img src="{{ url ('assets/img/logo-login.png') }}" width="200px" /></span>
                        @if($errors->all())
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3 text-center">
                                    <div class="col-xs-12 pb-3">
                                        <button class="btn d-block w-100 btn-lg btn-dark font-medium" type="submit">Login</button>
                                    </div>
                                </div>
