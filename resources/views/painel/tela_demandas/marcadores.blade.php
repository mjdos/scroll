        ...
        <div class="g-5 gx-xxl-8">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <span class="card-label fw-bolder fs-3 mb-1">Marcadores</span>
                    <div class="p-3">
                        <td class="text-end">
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-2" style="font-size: 13px;">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted bg-secondary">
                                    <th class="min-w-125px ps-2 rounded-start">Marcador</th>
